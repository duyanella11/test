...
if (isset($_GET['ptid'])) {
  $ptid = $_GET['ptid'];
  $sql = "select product.id, product.name, product.categories_id, product.product_type_id as 'ptid', product.image_name, product.short_desc, product_type.product_type FROM product INNER JOIN product_type on product.product_type_id = product_type.id where product.product_type_id = $ptid";
          ...
          <div class="col-lg-10">
            <div class="product">
              ...
              foreach ($productList as $item) {
                echo '<div data-aos="fade-up" class="col-md-3" style="border: solid 2px #e9e6e6; margin-top: 10px; margin-left: 20px;border-radius: 2vh;">
                ...
                <p data-aos="fade-up" class="text text-center" style="font-size: 20px; color: #140000"; height: 175px;>' . $item['short_desc'] . '</p>
                <span data-aos="fade-up" class="pview" style="border: 2.25px solid #cb515b; height: 37px; border-radius:15vh; padding: 5px; margin-left: 30%;">
